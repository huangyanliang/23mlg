...
<head>
	...
	<div class="main">
		<div class="addressBox">
			...
			<a href="<?php echo U('product/index');?>">产品中心</a> > <?php echo ($title); ?>
		</div>
		<div class="menuBox">
			<?php if(is_array($proMenu)): $i = 0; $__LIST__ = $proMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$proMenuobj): $mod = ($i % 2 );++$i;?><a class="hvr-radial-out" <?php if($type == $proMenuobj['Id']): ?>style="background-color:#05B181;color:#fff;"
		...
		<div class="products">
			<?php if(is_array($poducts)): $i = 0; $__LIST__ = $poducts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$productsobj): $mod = ($i % 2 );++$i;?><a href="<?php echo U('product/product','id='.$productsobj['Id']);?>">
					<dl>
