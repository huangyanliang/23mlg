...
<head>
	...
	<div class="main">
		<div class="addressBox">
			...
			<a href="<?php echo U('case/index');?>">工程案例</a> > <?php echo ($title); ?>
		</div>
		<div class="menuBox">
			<?php if(is_array($caseMenu)): $i = 0; $__LIST__ = $caseMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$caseMenuobj): $mod = ($i % 2 );++$i;?><a class="hvr-radial-out" <?php if($type == $caseMenuobj['Id']): ?>style="background-color:#05B181;color:#fff;"
					<?php else: endif; ?> href="<?php echo U('case/index','type='.$caseMenuobj['Id']);?>"><?php echo ($caseMenuobj['topic']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
		<div class="products">
			<?php if(is_array($poducts)): $i = 0; $__LIST__ = $poducts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$productsobj): $mod = ($i % 2 );++$i;?><a href="<?php echo U('case/caseShow','id='.$productsobj['Id']);?>">
					<dl>
						<dt><img src="/23mlg/uploads/images//<?php echo ($productsobj['pic']); ?>" title="<?php echo ($productsobj['topic']); ?>" alt="<?php echo ($productsobj['topic']); ?>" width="100%" /></dt>
						<dd>
							<h3 class="ell"><?php echo ($productsobj['topic']); ?></h3>
							<p class="ell2"><?php echo ($productsobj['intro']); ?></p>
						</dd>
					</dl>
				</a><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>

		<div class="jogger"><?php echo ($pageshow); ?></div>
	</div>
