...
<head>
	...
	<div class="main">
		<div class="addressBox">
			...
			<a href="<?php echo U('download/index');?>">下载专栏</a> > <a href="<?php echo U('download/index','type='.$data['inftype']);?>"><?php echo ($inftype); ?></a> > <?php echo ($data['topic']); ?>
		</div>
		<div class="menuBox">
			<?php if(is_array($downloadMenu)): $i = 0; $__LIST__ = $downloadMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$downloadMenus): $mod = ($i % 2 );++$i;?><a class="hvr-radial-out" <?php if($data['inftype'] == $downloadMenus['Id']): ?>style="background-color:#05B181;color:#fff;"
		...
		<div class="right_con">
             <div class="right_main_T">
                ...
                <h2>更新时间：<?php echo ($data['date']); ?>&nbsp;&nbsp;阅读：<?php echo ($data['hit']); ?></h2>
            </div>
