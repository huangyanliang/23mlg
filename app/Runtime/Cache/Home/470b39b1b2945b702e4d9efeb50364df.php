...
<head>
	...
	<div class="main">
		<div class="addressBox">
			...
			<a href="<?php echo U('news/index');?>">新闻资讯</a> > <a href="<?php echo U('news/index','type='.$data['inftype']);?>"><?php echo ($inftype); ?></a> > <?php echo ($data['topic']); ?>
		</div>
		<div class="menuBox">
			<?php if(is_array($newMenu)): $i = 0; $__LIST__ = $newMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newMenuobj): $mod = ($i % 2 );++$i;?><a class="hvr-radial-out" <?php if($data['inftype'] == $newMenuobj['Id']): ?>style="background-color:#05B181;color:#fff;"
