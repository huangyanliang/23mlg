...
<head>
			...
			<div class="navBox">
				<div class="logo">
					<a href="<?php echo U('index/index');?>"><img src="/23mlg/public/Home/images/logo.jpg" /></a>
				</div>
				<div class="nav">
					...
					<a href="<?php echo U('about/index');?>">
						<dl>
							...
							<ul>
								<?php if(is_array($aboutMenu)): $i = 0; $__LIST__ = $aboutMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aboutMenuts): $mod = ($i % 2 );++$i;?><a href="<?php echo U('about/index','id='.$aboutMenuts['Id']);?>"><li><?php echo ($aboutMenuts['topic']); ?></li></a><?php endforeach; endif; else: echo "" ;endif; ?>
							</ul>
						</dl>
					</a>
					<a href="">
		...
		<div class="product">
			<div class="main">
				<div class="productList"><a href="">
					<dl>
						<dt><img src="/23mlg/public/Home/images/pro1.png"/></dt>
						<dd>雨水回用</dd>
						<div class="pro_pic">
							<img src="/23mlg/public/Home/images/pro1.jpg" />
						</div>
					</dl>
				</a></div>
				<div class="productList"><a href="">
					<dl>
						<dt><img src="/23mlg/public/Home/images/pro2.png"/></dt>
						<dd>雨水回用</dd>
						<div class="pro_pic">
							<img src="/23mlg/public/Home/images/pro1.jpg" />
						</div>
				...
				<div class="productList"><a href="">
					<dl>
						<dt><img src="/23mlg/public/Home/images/pro3.png"/></dt>
						<dd>一体化预制泵站</dd>
						<div class="pro_pic">
							<img src="/23mlg/public/Home/images/pro1.jpg" />
						</div>
				...
				<div class="productList"><a href="">
					<dl>
						<dt><img src="/23mlg/public/Home/images/pro4.png"/></dt>
						<dd>变频供水设备</dd>
						<div class="pro_pic">
							<img src="/23mlg/public/Home/images/pro1.jpg" />
						</div>
				...
				<div class="productList"><a href="">
					<dl>
						<dt><img src="/23mlg/public/Home/images/pro5.png"/></dt>
						<dd>不锈钢水箱</dd>
						<div class="pro_pic">
							<img src="/23mlg/public/Home/images/pro1.jpg" />
						</div>
			...
			<div class="swiper-container case_r">
				<div class="swiper-wrapper">
					<?php if(is_array($case)): $i = 0; $__LIST__ = $case;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$caseobj): $mod = ($i % 2 );++$i;?><div class="swiper-slide">
						<a href=""><dl><dt class="ell"><?php echo ($caseobj['topic']); ?></dt>
