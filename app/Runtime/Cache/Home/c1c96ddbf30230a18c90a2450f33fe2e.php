...
<head>
	...
	<div class="main">
		<div class="addressBox">
			...
			<a href="<?php echo U('case/index');?>">工程案例</a> >
			<a href="<?php echo U('case/index','type='.$data['inftype']);?>"><?php echo ($inftype); ?></a> > <?php echo ($data['topic']); ?>
		</div>
		<div class="menuBox">
			<?php if(is_array($caseMenu)): $i = 0; $__LIST__ = $caseMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$caseMenuobj): $mod = ($i % 2 );++$i;?><a class="hvr-radial-out" <?php if($data['inftype'] == $caseMenuobj['Id']): ?>style="background-color:#05B181;color:#fff;"
		...
		<div class="proShow">
			<div class="casePic"><img src="/23mlg/uploads/images//<?php echo ($data['pic']); ?>"/></div>
