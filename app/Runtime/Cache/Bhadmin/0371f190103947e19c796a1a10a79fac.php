...
<body>
 ...
 <div class="" style="margin-bottom:10px;">
  <?php if($act == ''): echo btn(array('vals'=>'在线拼图','faicon'=>'puzzle-piece','size'=>3,'url'=>U('Fileupload/meituxiuxiu')));?>
   <?php echo btn(array('vals'=>'美化图片','icon'=>'picture','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=edit')));?>
   <?php echo btn(array('vals'=>'在线美图','faicon'=>'magic','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=online'))); endif; ?>
  <?php if($act == 'edit'): echo btn(array('vals'=>'在线拼图','faicon'=>'puzzle-piece','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu')));?>
   <?php echo btn(array('vals'=>'美化图片','icon'=>'picture','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=edit')));?>
   <?php echo btn(array('vals'=>'在线美图','faicon'=>'magic','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=online'))); endif; ?>
  <?php if($act == 'online'): echo btn(array('vals'=>'在线拼图','faicon'=>'puzzle-piece','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu')));?>
   <?php echo btn(array('vals'=>'美化图片','icon'=>'picture','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=edit')));?>
   <?php echo btn(array('vals'=>'在线美图','faicon'=>'magic','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=online'))); endif; ?>
 </div>
 <script src="http://open.web.meitu.com/sources/xiuxiu.js" type="text/javascript"></script>
 <script type="text/javascript">
	xiuxiu.setLaunchVars("nav","edit");
	<?php if($act == ''): ?>xiuxiu.embedSWF("xiuxiu", 2, 700, 500, "lite");
	 xiuxiu.setLaunchVars("nav",'puzzleModel');<?php endif; ?>
	
	<?php if($act == 'edit'): ?>xiuxiu.embedSWF("xiuxiu", 1, 700, 500, "lite");
	 xiuxiu.setLaunchVars("nav",'beautifySkin');
	 xiuxiu.setLaunchVars("sizeTipVisible", 1);<?php endif; ?>
	
	<?php if($act == 'online'): ?>xiuxiu.embedSWF("xiuxiu", 3, 700, 500, "lite");
	 xiuxiu.setLaunchVars("nav",'beautifySkin');
	 xiuxiu.setLaunchVars("sizeTipVisible", 1);<?php endif; ?>
	
	xiuxiu.onInit = function (id){
      xiuxiu.setUploadURL("<?php echo ($uploadurl); ?>");
