...
<body>
 ...
 <div class="pubmain">
 <h1><?php echo ($systitle); ?>管理<div class="pull-right"><?php echo btn(array('vals'=>'添加'.$systitle,'size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('website/linksadd','sty='.$sty.'&tables='.$dshow['table'])));?></div></h1>
 ...
 <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr class="active">
     ...
     <td align="left" valign="middle"><?php echo ($subtitle); ?>名称</td>
     <td width="260" align="left" valign="middle"><?php echo ($subtitle); ?>地址</td>
     <td width="100" align="center" valign="middle"><?php echo ($subtitle); ?>排序</td>
   ...
   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><tr class="maintr">
    ...
    <td align="left" valign="middle"><?php echo modField($obj['topic'],$obj['Id'],'topic',$dshow['table']);?></td>
    <td align="left" valign="middle"><?php echo modField($obj['linkurl'],$obj['Id'],'linkurl',$dshow['table']);?></td>
    ...
    <td align="center" valign="middle"><?php echo btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','url'=>U('website/linksmod','id='.$obj['Id'].'&tables='.$dshow['table'])));?></td>
   ...
   <?php else: ?>
    <div class="alert alert-danger">暂无留言数据。</div><?php endif; ?>
 </div>
