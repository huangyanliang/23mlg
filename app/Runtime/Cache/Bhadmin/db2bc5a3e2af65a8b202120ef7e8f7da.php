 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle();?>">
   <tr>
     ...
     <td height="32" align="left"><?php echo input(array('units'=>'注','name'=>'title','val'=>$data['title'],'tips'=>'栏目名称','width'=>20,'place'=>'栏目名称'));?></td>
   </tr>
   <tr>
     <td width="10%" height="32" align="right" valign="middle">栏目图标：</td>
     <td height="32" align="left" class="icontd"><?php echo input(array('faicon'=>'code','name'=>'icon','add'=>'code','val'=>$data['icon'],'tips'=>'栏目图标','width'=>20,'place'=>'栏目图标'));?></td>
   </tr>
   <tr>
     <td width="10%" height="32" align="right" valign="middle">图标类型：</td>
     <td height="32" align="left" class="icontype"><?php echo checkbox($data['isext'],0,'isext');?> <span class="text-warning"> 注：勾选表示扩展图标</span> </td>
   </tr>
   <tr>
     <td width="10%" height="32" align="right" valign="middle">栏目所属：</td>
     <td height="32" align="left">
     <?php if($mpid == 1): echo btn(array('vals'=>'顶级栏目','size'=>3,'add'=>'lev1','scene'=>'primary'));?>
       <?php echo btn(array('vals'=>'次级栏目','size'=>3,'add'=>'lev2','scene'=>'default'));?>
       <?php echo btn(array('vals'=>'小栏目','size'=>3,'add'=>'lev3','scene'=>'default')); endif; ?>
     <?php if($mpid == 2): echo btn(array('vals'=>'顶级栏目','size'=>3,'add'=>'lev1','scene'=>'default'));?>
       <?php echo btn(array('vals'=>'次级栏目','size'=>3,'add'=>'lev2','scene'=>'primary'));?>
       <?php echo btn(array('vals'=>'小栏目','size'=>3,'add'=>'lev3','scene'=>'default')); endif; ?>
     <?php if($mpid == 3): echo btn(array('vals'=>'顶级栏目','size'=>3,'add'=>'lev1','scene'=>'default'));?>
       <?php echo btn(array('vals'=>'次级栏目','size'=>3,'add'=>'lev2','scene'=>'default'));?>
       <?php echo btn(array('vals'=>'小栏目','size'=>3,'add'=>'lev3','scene'=>'primary')); endif; ?>
     </td>
   </tr>
   <tr class="topmenu" <?php if($data['tid'] == 0): ?>style="display:none;"<?php endif; ?>>
     <td width="10%" height="32" align="right" valign="middle">选择栏目：</td>
     <td height="32" align="left">
       <?php echo dropdown($topmenu,$lid,$mtopic,'lid');?>
       <div class="mmenu" style="background:#fff; min-height:30px; width:80%; padding:10px; margin:5px auto 0 0; border:dotted 1px #ddd;<?php if($mpid != 3): ?>display:none;<?php endif; ?>">
        <?php if($mpid == 3): echo ($mlist); endif; ?>
       </div>
     </td>
   </tr>
   
   <tr class="linktr" <?php if($data['tid'] == 0): ?>style="display:none;"<?php endif; ?>>
     <td width="10%" height="32" align="right" valign="middle">栏目链接：</td>
     <td height="32" align="left"><?php echo input(array('faicon'=>'link','val'=>$data['linkurl'],'name'=>'linkurl','tips'=>'参数和方法名之间用,隔开 例如：Website/datalist,tables=information&sty=2','width'=>40,'place'=>'栏目链接 Website/datalist,tables=information&sty=2'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">栏目排序：</td>
     <td height="32" align="left"><?php echo input(array('type'=>'text','scene'=>'ord','name'=>'ord','val'=>$data['ord']));?></td>
   </tr>
   <tr class="importanttr" <?php if($mpid != 3): ?>style="display:none;"<?php endif; ?>>
     <td height="32" align="right" valign="middle">是否重要：</td>
     <td height="32" align="left">
     <?php echo checkbox($data['isimportant'],0,'isimportant');?> <span class="text-warning"> 注：勾选表示权限比较重要</span>
     &nbsp;&nbsp;&nbsp;&nbsp;
     特殊权限：<?php echo checkbox($data['isspecial'],0,'isspecial');?> <span class="text-warning"> 注：勾选表示特殊权限</span>
   ...
   <tr class="opentr" <?php if($mpid != 2): ?>style="display:none;"<?php endif; ?>>
     <td height="32" align="right" valign="middle">是否展开：</td>
     <td height="32" align="left"><?php echo checkbox($data['isopen'],0,'isopen');?> <span class="text-warning"> 注：是否默认展开项目。</span></td>
   </tr>
   <input type="hidden" id="mpid" name="mpid" value="<?php echo ($mpid); ?>" />
   <input type="hidden" id="id" name="id" value="<?php echo ($data['Id']); ?>" />
   <input type="hidden" id="pid" name="pid" value="<?php echo ($data['tid']); ?>" />
   <tr>
     <td height="32" align="right" valign="middle">&nbsp;</td>
     <td height="32" align="left"><?php echo btn(array('vals'=>'保存栏目','size'=>3,'type'=>'submit','faicon'=>'code','scene'=>'primary'));?></td>
   </tr>
  </table>
  </form>
 </div>
