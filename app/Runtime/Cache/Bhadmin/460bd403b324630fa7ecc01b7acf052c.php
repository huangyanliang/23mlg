...
<body>
 ...
 <h1>部门列表 <div class="pull-right"><?php echo btn(array('vals'=>'添加部门','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('system/admindepartmentadd')));?></div></h1>
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   ...
   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><tr class="maintr">
    ...
    <td align="left" valign="middle"><?php echo btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','url'=>U('system/admindepartmentmod','id='.$obj['Id'])));?></td>
   ...
   <tr>
    ...
    <font class="text-warning">&nbsp;<?php echo icon('warning-sign');?> 提示，删除无法恢复，请谨慎操作。</font>
