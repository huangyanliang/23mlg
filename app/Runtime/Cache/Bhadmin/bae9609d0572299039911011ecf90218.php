        ...
        <div role="tabpanel" class="tab-pane active" id="instructions">
          <blockquote class="use">
            ...
            <ul>
             ...
             <li><a href="<?php echo U('System/sysmod');?>">B：系统设置</a> / <a href="<?php echo U('System/syswater');?>" data-pic="/bhv3.0/public/Bhadmin/images/useit/water.png">水印设置</a> / <a href="<?php echo U('System/sysupload');?>" data-pic="/bhv3.0/public/Bhadmin/images/useit/file.png">上传设置</a></li>
        ...
        <div role="tabpanel" class="tab-pane" id="contact">
         <blockquote class="contact-jxbh">
          ...
          <ul>
           ...
           <li>LOGO：<img src="/bhv3.0/public/Bhadmin/images/logo/bhlogo.png" height="20" alt="深圳市明良广电子商务有限公司"></li>
           <li>邮编：330006</li>
           <li>电话：0791-88117053</li>
           <li>邮箱：<img src="/bhv3.0/public/Bhadmin/images/bh@bxbht.png" alt="bh@bxbht.com" height="16"> </li>
           <li>作者：明良广</li>
