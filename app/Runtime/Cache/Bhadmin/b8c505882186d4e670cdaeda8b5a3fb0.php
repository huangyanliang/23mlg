...
<body>
 ...
 <div class="pubmain">
 <h1>客服管理<div class="pull-right"><?php echo btn(array('vals'=>'添加客服','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('website/onlineadd','tables='.$dshow['table'])));?></div></h1>
 <?php if($data != ''): ?><form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)"> 
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr class="active">
     ...
     <td width="100" align="center" valign="middle">客服排序</td>
   ...
   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><tr class="maintr">
    ...
    <td align="left" valign="middle"><?php echo ($obj['amount']); ?></td>
    ...
    <td align="center" valign="middle"><?php echo btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','url'=>U('website/onlinemod','tables='.$dshow['table'].'&id='.$obj['Id'])));?></td>
