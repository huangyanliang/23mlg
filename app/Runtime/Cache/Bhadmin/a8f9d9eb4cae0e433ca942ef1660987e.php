...
<head>
 ...
 <link href="/bhv3.0/public/Bhadmin/css/index.css" rel="stylesheet">
 <script src="/bhv3.0/public/Bhadmin/js/index.js" type="text/javascript"></script>
 <script src="/bhv3.0/public/Bhadmin/js/screenfull.min.js" type="text/javascript"></script>
...
<div id="header">
 ...
 <div class="admin-menu">
  <ul class="admin-menu-ul">
   ...
   <li><a data-id="0" href="http://www.23mlg.com" target="_blank"><?php echo icon('question-sign');?>关于明良广</a></li>
...
<div id="sidebar">
 ...
 <div id="rightmain">
     ...
     <b>当前位置：<a href="<?php echo U('index/main');?>" target="right">系统首页</a> <img src="/bhv3.0/public/Bhadmin/images/map_right.png" /> 管理中心 <img src="/bhv3.0/public/Bhadmin/images/map_right.png" /> <?php echo gtopic('adminauth',$tabid,'title');?></b> 
     </div>
