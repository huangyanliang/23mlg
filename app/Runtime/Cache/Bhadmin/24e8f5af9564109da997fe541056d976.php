...
<body>
 ...
 <div class="pubmain">
 <h1>添加管理部门</h1>
  <form name="adminform" method="post" action="<?php echo U('system/createdepartment');?>" onSubmit="return sysdepartment(document.adminform)">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr>
    ...
    <td height="32" align="left"><?php echo input(array('name'=>'topic','faicon'=>'gears','width'=>18,'place'=>'部门名称','tips'=>'必填'));?></td>
   </tr>
   <?php if($adminauth != ''): ?><tr>
     ...
     <td height="32" align="left">
      ...
      <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="table">
       ...
       <?php if(is_array($adminauth)): $i = 0; $__LIST__ = $adminauth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><tr id="adminauth<?php echo ($obj['Id']); ?>" class="active">
         <td align="center" valign="middle" height="37" class="lev1"><input data-lev="1" type="checkbox" value="<?php echo ($obj["Id"]); ?>" name="auth[]"></td>
         <td align="center" valign="middle"><?php echo ($obj['Id']); ?></td>
         <td align="left" valign="middle"><span class="opened" data-id="<?php echo ($obj['Id']); ?>"><?php echo faicon('plus-square','font');?></span> <?php echo ($obj['title']?:'--'); ?></td>
       </tr>
       <?php if($obj['mdata'] != ''): if(is_array($obj['mdata'])): $j = 0; $__LIST__ = $obj['mdata'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mobj): $mod = ($j % 2 );++$j;?><tr id="adminauth<?php echo ($mobj['Id']); ?>" class="adminauth<?php echo ($obj['Id']); ?>" style="display:none;">
             <td align="center" valign="middle" height="37" class="lev2"><input data-lev="2" type="checkbox" value="<?php echo ($mobj["Id"]); ?>" name="auth[]"></td>
             <td align="center" valign="middle"><?php echo ($mobj['Id']); ?></td>
             <td align="left" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="opened" data-id="<?php echo ($mobj['Id']); ?>"><?php echo faicon('plus-square','font');?></span> <?php echo ($mobj['title']?:'--'); ?></td>
           </tr>
           <?php echo showadminauth($mobj['Id'],2); endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; ?>
      </table>
      </div>
