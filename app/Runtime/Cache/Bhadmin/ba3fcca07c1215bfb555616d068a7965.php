   ...
   <form name="sysmod" method="post" action="">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle();?>">
      ...
      <tr>
        ...
        <td align="left" valign="middle"><?php echo input(array('name'=>'shieldip','val'=>$data['shieldip'],'type'=>'textarea'));?></tr>
      <tr>
        <td align="left" valign="middle">提示说明：</td>
        <td align="left" valign="middle"><?php echo input(array('name'=>'iptips','val'=>$data['iptips'],'icon'=>'question-sign','tips'=>'屏蔽IP提示说明'));?></td>
      </tr>
      <tr>
