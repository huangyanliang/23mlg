...
<body>
 ...
 <h1>资料管理<div class="pull-right"><?php echo btn(array('vals'=>'添加资料','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('website/aboutadd','tables='.$dshow['table'].'&sty='.$sty)));?></div></h1>
 <?php if($data != ''): ?><table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr class="active">
