...
.gear{ width:166px; height:198px; background:url(/23mlg/public/Admin/images/gear-line.png) no-repeat center center; position:absolute; z-index:1; left:460px; top:80px; display:none;} 
...
.bhface{ width:140px; height:140px; background:#3d3e3f url('/23mlg/public/Admin/images/logo/adminlogo.png') no-repeat center center; background-size:80%; border-radius:50%; border:solid 10px #363839; float:left; margin-right:20px; cursor:pointer; position:relative;}
...
<?php if($data['adminpath'] == ''): ?><form name="bhadmin" method="post" action="">
 ...
 <!--弹出对话框-->
 <div class="i-alert">
  <div class="i-alert-body"><img src="/23mlg/public/Admin/images/sign-icon.png" width="20"> <span class="alert-tips">我是提示</span> <b>&times;</b></div>
 </div>
 <!--结束-->     
 <div class="gear"><img src="/23mlg/public/Admin/images/gear.png" class="gear-div"></div>
 

 <script type="text/javascript" src="/23mlg/public/Admin/js/jquery.min.js"></script>
 <script type="text/javascript">
  function gcode() {
	var files = "<?php echo U('Admin/index/logincode','','');?>";
  ...
  $(".i-login-btn").click(function(e) {
	...
	$(".i-login-btn").val('登录中....');
    $.post( "<?php echo U('Admin/index/checklogin');?>", {'user':user,'pass':pass,'code':code},function(data){
	  $(".i-login-btn").val('登录');
	  var loginTips = '';
	  if(data==1){	
