 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle();?>">
   ...
   <tr class="hide">
     ...
     <td height="32" align="left"><?php echo input(array('name'=>'linkurl','place'=>'跳转链接','val'=>'','faicon'=>'link','tips'=>'注：跳转链接请提填此项，没有请勿填写。'));?></td>
   </tr>
   <tr class="hide">
     <td height="32" align="right" valign="middle">作者/来源：</td>
     <td height="32" align="left">
      <?php echo input(array('name'=>'author','place'=>'资料作者','width'=>'19','icon'=>'user','tips'=>'资料作者'));?>
      <?php echo input(array('name'=>'source','place'=>'资料来源','width'=>'19','icon'=>'globe','tips'=>'资料来源'));?>
     </td>
   </tr> 
   <tr>
     <td height="32" align="right" valign="middle">产品简介：</td>
     <td height="32" align="left"><?php echo input(array('name'=>'intro','type'=>'textarea','place'=>'资料简介，若不填写，自动截取资料详情里面的内容！'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">上传封面图片：</td>
     <td height="32" align="left"><?php echo uppic(array('tips'=>'产品封面图，300px*200px，没有要求可以不用上传！'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">上传图片集：</td>
     <td height="32" align="left"><?php echo upatlas();?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">产品内容：</td>
     <td height="32" align="left"><?php echo input(array('name'=>'content','type'=>'editor'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">页面关键词：</td>
     <td height="32" align="left"><?php echo input(array('name'=>'keyword','scene'=>'key'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">页面描述：</td>
     <td height="32" align="left"><?php echo input(array('name'=>'metades','scene'=>'des'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">是否置顶：</td>
     <td height="32" align="left"><?php echo checkbox(0,0,'istop');?> <span class="text-warning"> 注：勾选表示置顶</span></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left"><?php echo input(array('name'=>'date','scene'=>'date','width'=>'20','val'=>dates(),'tips'=>'请按照 2017-01-01 08:00:00 格式改写发布日期'));?></td>
   </tr>
   <tr>
