 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="<?php echo tabstyle();?>">
   <tr>
    ...
    <td height="32" align="left"><?php echo input(array('name'=>'topic','scene'=>'topic','tips'=>'产品标题（*必填）'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">产品所属：</td>
     <td height="32" align="left"><?php echo dropdownlink($dshow['mdata'],array('ctag'),array('promtag'));?></td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td height="32" align="left"><?php echo input(array('name'=>'linkurl','scene'=>'link','tips'=>'该商品淘宝购买链接'));?></td>
   </tr>
   <tr>
