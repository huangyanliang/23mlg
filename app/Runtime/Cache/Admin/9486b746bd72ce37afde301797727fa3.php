 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr>
    ...
    <td height="32" align="left"><?php echo input(array('name'=>'topic','scene'=>'topic','tips'=>'资料名称（*必填）'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">链接地址：</td>
     <td height="32" align="left"><?php echo input(array('name'=>'linkurl','scene'=>'link','place'=>'链接地址，跳转链接','tips'=>'链接地址，跳转链接'));?></td>
   </tr>
    <tr>
     <td height="32" align="right" valign="middle">上传图片：</td>
     <td height="32" align="left"><?php echo uppic(array('tips'=>'点击上传图片'));?></td>
   </tr>
   <tr>
