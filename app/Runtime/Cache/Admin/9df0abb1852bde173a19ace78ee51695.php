      ...
      <tr>
        ...
        <td height="42" align="left">
         ...
         <div class="waterview">
          ...
          <div data-id="0" class="waterdemo <?php if($data['facetype'] == 0): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式A');?>><img src="/23mlg/public/Admin/images/water/A.jpg"></div>
          <div data-id="1" class="waterdemo <?php if($data['facetype'] == 1): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式B');?>><img src="/23mlg/public/Admin/images/water/B.jpg"></div>
          <div data-id="2" class="waterdemo <?php if($data['facetype'] == 2): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式C');?>><img src="/23mlg/public/Admin/images/water/C.jpg"></div>
          <div data-id="3" class="waterdemo <?php if($data['facetype'] == 3): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式D');?>><img src="/23mlg/public/Admin/images/water/D.jpg"></div>
          <div data-id="4" class="waterdemo <?php if($data['facetype'] == 4): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式E');?>><img src="/23mlg/public/Admin/images/water/E.jpg"></div>
          <div data-id="5" class="waterdemo <?php if($data['facetype'] == 5): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式F');?>><img src="/23mlg/public/Admin/images/water/F.jpg"></div>
          <div data-id="6" class="waterdemo <?php if($data['facetype'] == 6): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式G');?>><img src="/23mlg/public/Admin/images/water/G.jpg"></div>
          <div data-id="7" class="waterdemo <?php if($data['facetype'] == 7): ?>selected<?php endif; ?>"<?php echo tooltip('字体样式H');?>><img src="/23mlg/public/Admin/images/water/H.jpg"></div>
         </div>
        </td>
      </tr>
      <tr>
