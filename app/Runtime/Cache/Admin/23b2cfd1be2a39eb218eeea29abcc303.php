 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   ...
   <tr>
     ...
     <td height="32" align="left"><?php echo uppic(array('pic'=>$data['pic'],'tips'=>'产品封面图，300px*200px，没有要求可以不用上传！'));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">上传图片集：</td>
     <td height="32" align="left"><?php echo upatlas($data['atlas']);?></td>
   </tr>
   <tr>
    <td width="10%" height="32" align="right" valign="middle">购买链接：</td>
    <td height="32" align="left"><?php echo input(array('name'=>'linkurl','scene'=>'link','val'=>$data['linkurl'],'tips'=>'该商品淘宝购买链接'));?></td>
   </tr>
   <tr>
