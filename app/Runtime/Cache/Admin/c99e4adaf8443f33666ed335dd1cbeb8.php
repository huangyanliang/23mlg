...
<body>
 ...
 <div class="pubmain">
 <h1>资料管理<div class="pull-right"><?php echo btn(array('vals'=>'添加产品','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('Product/productadd','sty='.$sty.'&tables='.$dshow['table'].'&martables='.$dshow['martable'])));?></div></h1>
