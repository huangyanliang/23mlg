 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr>
     ...
     <td height="32" align="left"><?php echo ($data['user']); ?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">手机号码：</td>
     <td height="32" align="left"><?php echo ($data['phone']); ?></td>
   </tr>
   <tr>
    <td width="10%" height="32" align="right" valign="middle">留言标题：</td>
    <td height="32" align="left"><?php echo input(array('name'=>'topic','scene'=>'topic','val'=>$data['topic']));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">留言内容：</td>
     <td height="32" align="left"><?php echo input(array('type'=>'textarea',name=>'intro','val'=>$data['content']));?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">留言时间：</td>
     <td height="32" align="left"><?php echo ($data['date']); ?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">是否处理：</td>
     <td height="32" align="left"><?php echo checkbox($data['enabled']);?> <span class="text-warning"> 注：勾选表示处理</span></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">留言IP：</td>
     <td height="32" align="left"><?php echo ($data['ip']); ?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">&nbsp;</td>
     <input type="hidden" value="<?php echo ($data['Id']); ?>" name="id">
     <td height="32" align="left"><?php echo btn(array('vals'=>'处理留言','size'=>3,'type'=>'submit','icon'=>'comment','scene'=>'primary'));?></td>
   </tr>
  </table>
  </form>
 </div>
