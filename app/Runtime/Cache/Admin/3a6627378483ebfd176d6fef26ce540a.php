 ...
 <div class="pubmain">
  ...
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   ...
   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i;?><tr class="maintr">
     <td align="center" valign="middle" height="37"><?php echo ckbox($obj['Id'],$i);?></td>
     ...
     <td align="center" valign="middle"><?php echo modattr($obj['Id'],$obj['enabled'],'message','enabled',array('处理','取消'));?></td>
     <td align="center" valign="middle"><?php echo showdate($obj['date']);?></td>
     <td align="center" valign="middle"><?php echo btn(array('vals'=>'查看','icon'=>'comment','tips'=>'点击查看留言数据','url'=>U('messageshow','id='.$obj['Id'])));?></td>
   ...
   <?php else: ?>
    <div class="alert alert-danger">暂无留言资料。</div><?php endif; ?>
 </div>
