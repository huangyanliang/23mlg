 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr>
    ...
    <td height="32" align="left"><?php echo input(array('name'=>'topic','width'=>20,'icon'=>'user','place'=>'客服名称','tips'=>'客服名称（*必填）'));?></td>
   </tr>
   <tr>
    <td width="10%" height="32" align="right" valign="middle">客服账号：</td>
    <td height="32" align="left"><?php echo input(array('name'=>'amount','place'=>'客户账户，QQ号码','width'=>20,'icon'=>'user','tips'=>'客服账号（*必填）'));?></td>
   </tr>
   <tr class="hide">
    <td width="10%" height="32" align="right" valign="middle">微信号码：</td>
    <td height="32" align="left"><?php echo input(array('name'=>'weixin','icon'=>'qrcode','place'=>'微信号码','width'=>20,'tips'=>'微信号码'));?></td>
   </tr>
   <tr class="hide">
    <td width="10%" height="32" align="right" valign="middle">手机号码：</td>
    <td height="32" align="left"><?php echo input(array('name'=>'phone','icon'=>'phone','place'=>'手机号码','width'=>20,'tips'=>'手机号码'));?></td>
   </tr>
   <tr>
   ...
   <tr>
     <td height="32" align="right" valign="middle">&nbsp;<input type="hidden" value="<?php echo ($tables); ?>" name="tables"></td>
