 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr>
    ...
    <td height="32" align="left"><?php echo input(array('name'=>'topic','scene'=>'topic','val'=>$data['topic'],'tips'=>'资料标题（*必填）'));?></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left">
      ...
      <?php echo input(array('name'=>'source','place'=>'资料来源','val'=>$data['source'],'width'=>'20','icon'=>'globe','tips'=>'资料来源'));?></td>
   </tr> 
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left"><?php echo uppic(array('pic'=>$data['pic'],'tips'=>'资料配图，前台若不显示可忽略此项！'));?></td>
   </tr>
   <tr>
