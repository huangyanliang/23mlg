      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="contact">
         <blockquote class="contact-jxbh">
          ...
          <ul>
           ...
           <li>LOGO：<img src="__img__/logo/bhlogo.png" height="20" alt="深圳市明良广电子商务有限公司"></li>
           <li>邮编：330006</li>
           <li>电话：0791-88117053</li>
           <li>邮箱：<img src="__img__/bh@bxbht.png" alt="bh@bxbht.com" height="16"> </li>
           <li>作者：明良广</li>
           <li>官网：<a href="http://www.jxbh.cn" target="_blank">{:icon('link')} http://www.jxbh.cn</a></li>
          </ul>
         </blockquote>
        </div>
        <div role="tabpanel" class="tab-pane" id="bug">
         <blockquote class="updata-log">
          ...
          <ul>
           <li>反馈地址：<a href="http://www.jxbht.com/article/35.html" target="_blank">{:icon('link')} http://www.jxbht.com/article/35.html </a></li>
