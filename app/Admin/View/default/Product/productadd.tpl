 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
   <tr>
    ...
    <td height="32" align="left">{:input(array('name'=>'topic','scene'=>'topic','tips'=>'产品标题（*必填）'))}</td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td height="32" align="left">{:input(array('name'=>'linkurl','scene'=>'link','tips'=>'该商品淘宝购买链接'))}</td>
   </tr>
   <tr>
