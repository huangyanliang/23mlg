 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   ...
   <tr>
     ...
     <td height="32" align="left">{:input(array('name'=>'linkurl','place'=>'跳转链接','val'=>$data['linkurl'],'faicon'=>'link','tips'=>'注：跳转链接请提填此项，没有请勿填写。'))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">作者/来源：</td>
     <td height="32" align="left">
      {:input(array('name'=>'author','place'=>'资料作者','val'=>$data['author'],'width'=>'20','icon'=>'user','tips'=>'资料作者'))} 
      {:input(array('name'=>'source','place'=>'资料来源','val'=>$data['source'],'width'=>'20','icon'=>'globe','tips'=>'资料来源'))}</td>
   </tr> 
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left">{:input(array('name'=>'date','val'=>$data['date'],'scene'=>'date','width'=>'20','tips'=>'请按照 2017-01-01 08:00:00 格式改写发布日期'))}</td>
   </tr>
   <tr>
